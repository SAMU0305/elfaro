...
<body>
    ...
    <section class="section has-text-centered">
        ...
        <!-- Título -->
        <h1 class="title  is-2 mt-3">"Lo mas relevante del mundo del Deporte"</h1>
        ...
        <div class="container">
          <div class="notification is-primary banner-publicidad">
            <div class="columns is-vcentered">
              ...
              <!-- Columna principal con imagen centrada y texto -->
              <div class="column is-10 has-text-centered">
                ...
                <p class="has-text-white is-size-5 mt-4">
                  Ya que estás aquí, ¡Aprovecha nuestra oferta especial! Descuento del 20% al suscribirte a nuestra página hoy!! y podrás tener geniales beneficios como 100 publicaciones gratis de las noticias que tú quieras, posibilidad de personalizar la página, entre otros. ¡No te lo pierdas!
                </p>
              </div>
    ...
    <section class="section">
      <div class="container">
        <div class="columns is-multiline" id="news-container">
          <div id="news-Section" class="columns is-multiline">
